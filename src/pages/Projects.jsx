        ...
        {projects.map((project, idx) => {
          ...
          return (
            <motion.article
              ...
              className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-sm p-6 hover:scale-[1.02] transition duration-300"
            >
              <div className="flex justify-between items-start gap-4 mb-4">
                <div className="flex-1 min-w-0">
                  ...
                  <p className={"text-sm ml-9 font-medium " + gradientText}>
                    {project.type}
                  </p>
                </div>
                ...
                <img
                  src={project.image}
                  alt={project.name}
                  className="w-52 h-28 rounded-xl object-cover border border-white/10 flex-shrink-0"
                />
              </div>
